## v0.4.13.86 / v0.4.3.24 — artem — 2026-06-10
**Branch:** artem
**VM:** potempc
**Agent:** Artem
...
- `control-panel/src/lib/apps/lxd-updater.ts` — Installs Caddy's root CA into LXD apps before no-op update exits so UI can proxy HTTPS Caddy grants.
...
- `control-panel/package.json`, `ui/package.json`, `ui/public/sw.js`, `README.md` — Bumped Control Panel to `0.4.13.86`, UI to `0.4.3.24`, and updated current version records.
...
- `pnpm --dir control-panel build` passed for Control Panel `0.4.13.86`.
...
- Artifact verification passed: CP and UI `standalone.tar` files contain top-level `server.js` and package versions `0.4.13.86` / `0.4.3.24`.
