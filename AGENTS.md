## v0.4.13.89 / v0.4.3.25 — artem — 2026-06-10
**Branch:** artem
**VM:** potempc
**Agent:** Artem
...
- `control-panel/src/lib/bridges/manager.ts`, `control-panel/src/lib/market/ui-manifest-sync.ts` — Pushes installed connection candidates with proxy URL and route-scope metadata during bridge changes and manifest sync/update so UI can offer them as per-user permissions.
