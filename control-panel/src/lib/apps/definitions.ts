...
export const APP_DEFINITIONS: AppDefinition[] = [
  ...
  // ─── Native Apps ────────────────────────────────────────────
  {
    ...
    category: 'user',
    type: 'lxd',
    containers: [{ name: 'app-wiki', canControl: true }],
    updatedBy: 'control-panel',
    webPort: 3000,
    lxdConfig: {
      giteaRepo: 'YE-App-Wiki',
      appDir: '/opt/app',
      serviceName: 'app-wiki',
      healthEndpoint: '/api/health',
    },
  },
  {
    ...
    category: 'user',
    type: 'lxd',
    containers: [{ name: 'app-search', canControl: true }],
    updatedBy: 'control-panel',
    webPort: 3000,
    lxdConfig: {
      giteaRepo: 'YE-App-Search',
      appDir: '/opt/app',
      serviceName: 'app-search',
      healthEndpoint: '/api/health',
    },
  },
  {
    ...
    category: 'user',
    type: 'lxd',
    containers: [{ name: 'app-notes', canControl: true }],
    updatedBy: 'control-panel',
    webPort: 3000,
    lxdConfig: {
      giteaRepo: 'YE-App-Notes',
      appDir: '/opt/app',
      serviceName: 'app-notes',
      healthEndpoint: '/api/health',
    },
  },
  {
    ...
    category: 'user',
    type: 'lxd',
    containers: [{ name: 'app-cinema', canControl: true }],
    updatedBy: 'control-panel',
    webPort: 3000,
    lxdConfig: {
      giteaRepo: 'YE-App-Cinema',
      appDir: '/opt/app',
      serviceName: 'app-cinema',
      healthEndpoint: '/api/health',
    },
  },
  {
    ...
    category: 'user',
    type: 'lxd',
    containers: [{ name: 'app-weather', canControl: true }],
    updatedBy: 'control-panel',
    webPort: 3000,
    lxdConfig: {
      giteaRepo: 'YE-App-Weather',
      appDir: '/opt/app',
      serviceName: 'app-weather',
      healthEndpoint: '/api/health',
    },
  },
  {
    ...
    category: 'user',
    type: 'lxd',
    containers: [{ name: 'app-translate', canControl: true }],
    updatedBy: 'control-panel',
    webPort: 3000,
    lxdConfig: {
      giteaRepo: 'YE-App-Translate',
      appDir: '/opt/app',
      serviceName: 'app-translate',
      healthEndpoint: '/api/health',
    },
  },
];
