...
| Component | Version |
|-----------|---------|
| Spine | 0.4.10.5 (`spine-dev-v0.4.10.5`) |
| Installer | 0.1.0.3 (`installer-dev-v0.1.0.3`) |
| Control Panel | 0.4.49.21 (`cp-dev-v0.4.49.21`) |
...
| Notes | 0.4.5 (`v0.4.5`) |
| Cinema | 0.4.4 (`v0.4.4`) |
| Weather | 0.4.3 (`v0.4.3`, released, not installed) |
| Translate | 0.4.4 (`v0.4.4`) |
