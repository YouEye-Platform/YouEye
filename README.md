...
| Control Panel | 0.4.53 (`cp-v0.4.53`) |
| UI | 0.4.35 (`ui-v0.4.35`) |
| Canvas | 0.3.5 (`v0.3.5`) |
| Wiki | 0.4.11 (`v0.4.11`) |
| Search | 0.4.11 (`v0.4.11`) |
| Notes | 0.4.12 (`v0.4.12`) |
| Cinema | 0.4.11 (`v0.4.11`) |
| Weather | 0.4.10 (`v0.4.10`) |
| Translate | 0.4.11 (`v0.4.11`) |
