...
| Control Panel | `cp-v0.2.22` | `cp-dev-v0.2.22.1` | `cp-sebastian-v0.2.22.2` |
| UI | `ui-v0.2.22` | `ui-dev-v0.2.22.1` | `ui-sebastian-v0.2.22.1` |
...
| Control Panel | 0.2.22 | 0.2.21.11 | 0.2.22.2 |
| UI | 0.2.22 | 0.2.21.11 | 0.2.22.2 |
