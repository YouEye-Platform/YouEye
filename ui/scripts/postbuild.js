...
const needed = [
  'next', 'react', 'react-dom', '@swc/helpers', '@swc/counter', '@next/env',
  'styled-jsx', 'client-only', 'yaml', 'zod',
  // sharp and its full transitive dependency tree
  'sharp', 'semver', 'detect-libc', 'color', 'color-convert', 'color-string',
  'color-name', 'simple-swizzle', 'is-arrayish',
];
