...
const USER_SECTIONS = [
  ...
  { id: "privacy", labelKey: "privacy" as const, icon: Lock, href: "/settings/privacy" },
];

// Market intentionally removed from Settings (Plan 1 D9 — Market is a launcher app
// with its own Sources page, not a Settings destination).
