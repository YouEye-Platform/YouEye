...
- Name: settings-apps.spec.ts >> Settings Apps Restructure >> admin sidebar shows App Management
- Location: tests/settings-apps.spec.ts:67:7
...
Locator: locator('nav a[href="/settings/apps-list"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('nav a[href="/settings/apps-list"]')
