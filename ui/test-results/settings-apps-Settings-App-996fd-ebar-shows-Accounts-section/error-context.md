...
- Name: settings-apps.spec.ts >> Settings Apps Restructure >> sidebar shows Accounts section
- Location: tests/settings-apps.spec.ts:61:7
...
Locator: locator('nav a[href="/settings/accounts"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('nav a[href="/settings/accounts"]')
