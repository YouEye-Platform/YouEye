...
- Name: settings-apps.spec.ts >> Settings Apps Restructure >> /settings/connectors redirects to /settings/apps
- Location: tests/settings-apps.spec.ts:73:7
...
Call log:
  - navigating to "https://devvm.test/settings/connectors", waiting until "networkidle"
