...
```yaml
releases:
  base_url: "https://git.byka.wtf"  # Base URL for release downloads
  api_path: "/api/v1"               # API path for version checks
  organization: "potemsla"          # Organization/owner name
  repositories:
    spine: "YE-Spine"               # Repository for Spine releases
    control_panel: "YE-ControlPanel" # Repository for Control Panel releases
```
...
releases:
  base_url: "https://git.byka.wtf"
  api_path: "/api/v1"
  organization: "potemsla"
  repositories:
    spine: "YE-Spine"
    control_panel: "YE-ControlPanel"
...
|-------------------|-------------|---------|
| `https://git.byka.wtf` | `releases.base_url` | `https://git.byka.wtf` |
